...
import { ResponseFormatRenderer } from "./ResponseFormats";
import { isKnownFormat } from "./formatRegistry";
...
export const ChatMessage: React.FC<ChatMessageProps> = ({
  ...
  const hasStructuredFormat = type === "ai" && isKnownFormat(format);
  ...
  return (
    ...
    >
      ...
      `}
      >
        {hasStructuredFormat && format ? (
          <ResponseFormatRenderer
            format={format}
